...
/**
 * Klasa odpowiadaj�ca m.in. za wystartowanie Timera, stworzenie obiektu gracza,
 * wy�wietlenie okna z gr�, odtwarzanie muzyki w tle, wy�wietlanie menu, a tak�e
 * grafiki zale�nej od poziomu gry, a tak�e za obs�ug� klawiatury.
 *
...
public class Gameplay extends JPanel implements KeyListener, ActionListener {
    ...
    /**
     * Konstruktor klasy "Gameplay" tworz�cy obiekt gracza (nowy obiekt klasy
     * "Player" o okre�lonych wsp�rz�dnych), obiekt paska �ycia (nowy obiekt klasy
     * "Health"), tak�e obiekt klasy "Actions", a tak�e tworzy Boss�w. Konstruktor
     * ten tworzy r�wnie� nowe okno z gr�, startuje licznik oraz uruchamia obs�ug�
     * klawiatury.
     */
    public Gameplay() {
    ...
    /**
     * Funkcja odpowiadaj�ca za wy�wietlanie element�w graficznych (menu, a tak�e
     * element�w zale�nych od aktualnego poziomu).
     */
    @Override
    ...
    /**
     * Funkcja odpowiadaj�ca za odmalowywanie okna z gr�, a tak�e za rozgrywk� -
     * okre�la ona r�ne warunki gry w zale�no�ci od aktualnego poziomu, a tak�e
     * okre�la w jaki spos�b poziomy maj� si� zmienia�, kiedy ma nast�powa� koniec
     * gry, a kiedy wygrana.
     */
    @Override
    ...
    /**
     * Funkcja odpowiadaj�ca za obs�ug� klawiatury.
     */
    @Override
